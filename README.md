...
range	immutable	An immutable sequence of numbers, commonly used for iterating a specific number of times in for loops[112]	range(−1, 10)
range(10, −5, −2)
...
Jupyter Notebooks, an open-source interactive computing platform;[131]
PythonAnywhere, a browser-based IDE and hosting environment; and
Canopy, a commercial IDE from Enthought that emphasizes scientific computing.[132][133]
Implementations
...
Cobra has an Acknowledgements document that lists Python first among influencing languages.[193]
ECMAScript and JavaScript borrowed iterators and generators from Python.[194]
Go is designed for "speed of working in a dynamic language like Python".[195]
Julia was designed to be "as usable for general programming as Python".[196]
Mojo is almost[34][197] a superset of Python.[198]
GDScript is strongly influenced by Python.[199]
...
Tier 1: 64-bit Linux, macOS; 64- and 32-bit Windows[6]
...
Unofficial (or has been known to work): Other Unix-like/BSD variants) and a few other platforms[8][9][10]
 ...
 Also known as PEP[80]
 to describe a new feature on Python
 to describe a design issue or providing a general guideline
 to describe a process surrounding in Python
References
 ...
 "Python 3.14.7 final". 5 August 2026. Retrieved 5 August 2026.
 ...
 Cannon, Brett (20 February 2015). "PEP 488 – Elimination of PYO files". Python Enhancement Proposals (PEPs). Archived from the original on 16 January 2026. Retrieved 28 February 2026. A PYC file is the bytecode file generated and read from when no optimization level is specified at interpreter startup [...] .pyc
 Ahlstrom, James C. (11 October 2001). "PEP 273 – Import Modules from Zip Archives". Python Enhancement Proposals (PEPs). Archived from the original on 25 February 2026. Retrieved 28 February 2026. Dynamic modules have extensions like .dll, .pyd, and .so.
 Harper Smith, Emma (9 September 2017). "PEP 561 – Distributing and Packaging Type Information". Python Enhancement Proposals (PEPs). Archived from the original on 7 December 2025. Retrieved 28 February 2026. 'stubs' - files containing only type information, empty of runtime code (the filename ends in .pyi).
 ...
 van Kemenade, Hugo (2 June 2026). "Python 3.15.0 beta 2 is here!". Python Insider. Retrieved 18 June 2026.
 ...
 Warsaw, Berry; Hylton, Jeremy; Goodder, David (13 June 2000). "PEP 1 – PEP Purpose and Guidelines". peps.python.org. Retrieved 6 May 2026.
 "Python Enhancement Proposal (PEP)". Retrieved 6 May 2026.
 "What is a PEP in Python?". believemy.com. Retrieved 7 May 2026.
 ...
 "What's new in Python 3.15". Python documentation. Retrieved 30 April 2026.
 ...
 "on what systems does Python not use IEEE-754 double precision floats". Stack Overflow. Retrieved 7 June 2026.
 ...
 "ArrowNotImplementedError: halffloat error on applying pandas.to_feather on a dataframe". Stack Overflow. Retrieved 8 June 2026.
 "Exotic Floating Point Formats — bitstring 4.3 documentation". bitstring.readthedocs.io. Retrieved 8 June 2026.
 ...
 "VMS Python compatibility issues - VSI OpenVMS Wiki". wiki.vmssoftware.com. Retrieved 8 June 2026.
 "Python and Python Wheels for OpenVMS — VMS Software, Inc". docs.vmssoftware.com. Retrieved 8 June 2026.
 ...
 RustPython/RustPython, RustPython Dev, 5 May 2026, retrieved 6 May 2026
...
The Python Tutorial
CultRepo (28 August 2025). The Story of Python and how it took over the world | Python: The Documentary. Retrieved 22 July 2026 – via YouTube.
vte
Python
Implementations	
...
IDEs	
ericIDLEPyCharmPyDevSpydermore...
Topics	
WSGIASGIHistory of PythonZen of Python
Designer	
Guido van Rossum
...
AdaALGOL SimulaAPLAssemblyBASIC Visual Basic classic.NETCC++C#COBOLErlang ElixirForthFortranGoHaskellJavaJavaScriptJuliaKotlinLispLuaMATLABML Caml OCamlStandard MLPascal Object PascalPerl RakuPHPPrologPythonRRubyRustSASSQLScratchShellSmalltalkSwiftmore...
